...
public class DemoFF {
	...
	urlselection = input.nextInt();
		...
		case 1 : url="https://www.google.com/";
		break;
		case 2 : url="https://www.facebook.com/";
		break;
		default : System.out.println("Incorrect Selection");
		...
		if( (browser.equalsIgnoreCase("chrome")) && (url.equalsIgnoreCase("https://www.google.com/") || url.equalsIgnoreCase("https://www.facebook.com/"))) {
		...
		else if ( (browser.equalsIgnoreCase("firefox")) && (url.equalsIgnoreCase("https://www.google.com/") || url.equalsIgnoreCase("https://www.facebook.com/"))) {
